...
<body class="bg-light">
          ...
          <form action="">
            ...
            <div class="modal-body">
              <span class="badge rounded-pill bg-light text-dark mb-3 text-wrap lh-base">
                Note: Your details must match with your ID (KTP, SIM Card, Passport, etc.) that will be required during check-in. 
              </span>
              <div class="container-fluid">
                <div class="row">
    ...
    <!-- Check Booking Availiability Form-->
        ...
        <div class="swiper-wrapper mb-5">
          <div class="swiper-slide bg-white p-4">
            ...
            <p>
              ...
              Enim eveniet voluptas non temporibus, doloribus voluptatem.
            </p>
            <div class="rating">
              <i class="bi bi-star-fill text-warning"></i>
              <i class="bi bi-star-fill text-warning"></i>
    ...
    <div class="container-fluid bg-white mt-5">
      <div class="row">
        <div class="col-lg-4 p-4">
          <h3 class="h-font fw-bold fs-3">MR Hotel</h3>
          <p>
            Lorem ipsum dolor sit amet consectetur 
            adipisicing elit. Accusamus aliquam quia 
            vitae quisquam expedita? Consectetur!
          </p>
        </div>
        <div class="col-lg-4 p-4">
    ...
    <script>
      ...
      // Add click event listener manually
